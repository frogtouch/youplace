...
describe('CreateUser', function () {
    ...
    it('should be able to craete a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
    ...
    it('should not be able to craete a new user with same email from another', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUser.execute({
                        name: 'John Doe',
