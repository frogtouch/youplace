...
describe('ListProviders', function () {
    ...
    it('should be able to list the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    loggedUser = _a.sent();
                    return [4 /*yield*/, listProviders.execute({ user_id: loggedUser.id })];
                case 4:
                    providers = _a.sent();
